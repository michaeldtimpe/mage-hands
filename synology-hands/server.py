...
def _performance(host, out) -> dict:
    ...
    # memory + swap — DSM's 3.10 kernel has no MemAvailable, so memory_stats() approximates
    # it rather than falling back to MemFree (which reads as ~99% used). See core meminfo.
